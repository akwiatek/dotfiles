...
try_git_clone https://github.com/neovim/nvim-lspconfig
...
amend_path '/opt/nvim-linux-x86_64/bin'
...
if which chromium-browser; then
    echo "export CHROME_BIN=$(which chromium-browser)" >> .zsh_path
fi
